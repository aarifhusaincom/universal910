...
http.createServer((req,res)=>{
 ...
 {
    if(req.method=="GET")
        response_msg="<h1>/service url invoked & method GET</h1>";
    else if(req.method=="POST")
        response_msg="<h1>/service url invoked & method POST</h1>";
    else if(req.method=="PUT")
        response_msg="<h1>/service url invoked & method PUT</h1>";
    else if(req.method=="PATCH")
        response_msg="<h1>/service url invoked & method PATCH</h1>";
    else if(req.method=="DELETE")
        response_msg="<h1>/service url invoked & method DELETE</h1>";
    else
        response_msg="<h1>/service url invoked & method Anonymous</h1>";                
 }
